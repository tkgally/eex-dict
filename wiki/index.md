...
- [crossref-cross-type-backlinks](notes/crossref-cross-type-backlinks.md) — `crossref.py` added a back-link of one type (synonym, compare) where the target already named the source under another, making the pair both; caught 2026-09-26 on *contain/include* and *tell/inform*, reverted by hand. Fix due a later run.
