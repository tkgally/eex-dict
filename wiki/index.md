...
- [lint-vocab-changed-base](notes/lint-vocab-changed-base.md) — the local `lint_vocab.py --gate --changed` passed a definition violation (*border* in `close-v`) that CI's gate, run against `origin/main`, caught; caught 2026-09-24. Workaround `--base origin/main`; fix due a later run.
