...
- [crossref-first-sense-backlinks](notes/crossref-first-sense-backlinks.md) — `crossref.py` puts a sense back-link on the target's first sense when no sense already names the source; five of 13 added 2026-09-24 were on the wrong sense and were moved by hand. The promised "added as a back-link" note is not written. Fix due a later run.
