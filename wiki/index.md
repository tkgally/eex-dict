...
- [reviewer-noise](notes/reviewer-noise.md) — reviewer-a called all 10 sampled definitions "copied" in the first originality check, unsupported by search evidence in 7 of 10; updates through the fourth check (2026-09-23), where asking for a quoted source ended the false calls but left only "cannot tell".
